...
module.exports.getConfigurations = function() {
  ...
  var allowToCreateSqlServer;
  switch (config['privilege']['sqldb']['allowToCreateSqlServer']) {
      case undefined:
...
          break;
      default:
          throw Error('Error in manifest parameter: AZURE_SQLDB_ALLOW_TO_CREATE_SQL_SERVER');
  }
  config['privilege']['sqldb']['allowToCreateSqlServer'] = allowToCreateSqlServer;
